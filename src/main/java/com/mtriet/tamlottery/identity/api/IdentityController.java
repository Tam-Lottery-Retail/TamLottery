...
public class IdentityController {
    ...
    @PreAuthorize("hasAnyRole('OWNER','MANAGER')")
    IdentityDtos.SellerResponse updateSeller(@PathVariable Long id,
                                             @Valid @RequestBody IdentityDtos.UpdateSellerRequest request) {
        return identityService.updateSeller(id, request);
    }
